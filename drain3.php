		...
		<div class="site-content">
				...
				<div class="container">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							...
							<li class="menu-item current-menu-item"><a href="drain3.php">Drain 3</a></li>
			...
			<div class="container">
				<div class="col-lg-12 py-4 px-0">
					<h2 class="m-0 table-h-custom">Drain 3 Water Level Forecast</h2>
				</div>
			 </div>	
			<section id="drain1">
                    ...
                    <div class="row">
						<div class="col-lg-12">
							<div class="forecast-table">
								<div class="forecast-container m-0">
									<?php
										$sql = "SELECT * FROM rainfall WHERE status = 'active' AND drain_id = 3 ORDER BY forecast_time ";
						...
						<div class="forecast">
							...
							<div id="depth-forecast" class="forecast-content">
                                <script>
                                    for(var i = 0; i < 4; i++) {
													document.getElementById("depth-forecast").innerHTML += '<div>4.79</div>';
												}
                                </script>
