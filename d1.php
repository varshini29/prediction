...
function getForecast() {
    $times = array();
    global $conn;
    $sql = "SELECT * FROM rainfall WHERE status = 'active' AND drain_id = 1";
...
$writer->write($document, 'C:\Users\varsh\Documents\Applied-Computing\Dissertation\WEKA\ANN\forecast_d1.arff');
